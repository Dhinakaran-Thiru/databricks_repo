...
# DBTITLE 1,Writing the files
def write_csv_file(df,path):
  df.write.format("csv").save(path)

# COMMAND ----------

# DBTITLE 1,Reading Schemas
...
# DBTITLE 1,Reading the file with different  methods
...
# DBTITLE 1,Convert the column Camel case to Snake Case
...
# DBTITLE 1,Delta table using pyspark
...
# DBTITLE 1,Read with Custom Schema
